...
class MovieSearchApp:
    def __init__(self, root):
        ...
        self.accent_color = "#fe7373"
        self.input_fg = "#000000"
        self.input_highlight = "#ffd9d9"
        ...
        self.search_frame.pack(fill="x", pady=20)
        ...
        # Bind the canvas resizing to update the scroll region dynamically
        ...
        # Mouse wheel scrolling (ensure smooth and consistent behavior)
